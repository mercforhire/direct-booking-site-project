...
- Usage: Reference from command with `@/Users/LeonChen/Documents/direct booking site project/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/LeonChen/Documents/direct booking site project/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/LeonChen/Documents/direct booking site project/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
