...
- [x] **Phase 16: Guest Booking History** - Home page guest login link; authenticated guests can view past and upcoming bookings (completed 2026-03-31)
...
- [ ] 11-02-PLAN.md — Webhook email send in date_change_topup branch + page.tsx date_change_paid fallback + success banner + DateChangeSection PAID state
- [ ] 11-03-PLAN.md — cancelDateChange + cancelExtension token auth guards + DateChangeSection/ExtensionSection/BookingStatusView token prop threading
...
- [ ] 15-02-PLAN.md — calculatePriceEstimate perDayRates support (TDD)
- [ ] 15-03-PLAN.md — setDatePriceOverride, clearDatePriceOverride, setRangePriceOverride server actions (TDD)
...
Plans:
- [x] TBD (run /gsd:plan-phase 17 to break down) (completed 2026-04-01)
