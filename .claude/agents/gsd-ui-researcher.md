...
Use template from `/Users/LeonChen/Documents/direct booking site project/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/LeonChen/Documents/direct booking site project/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/LeonChen/Documents/direct booking site project/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
