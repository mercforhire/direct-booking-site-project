    ...
    <div className="booking-dark">
      <style>{`
        ...
        .booking-dark textarea {
          background: color-mix(in srgb, var(--ll-text) 5%, transparent) !important;
          border: 1px solid color-mix(in srgb, var(--ll-text) 12%, transparent) !important;
          color: var(--ll-text) !important;
          border-radius: 8px !important;
          transition: border-color 0.2s ease, box-shadow 0.2s ease !important;
        }
        .booking-dark input::placeholder,
        .booking-dark textarea::placeholder { color: var(--ll-text)40 !important; }
        .booking-dark input:focus,
        .booking-dark textarea:focus {
          border-color: var(--ll-accent) !important;
          box-shadow: 0 0 0 3px color-mix(in srgb, var(--ll-accent) 12%, transparent) !important;
          outline: none !important;
        }
        .booking-dark input::-webkit-outer-spin-button,
        .booking-dark input::-webkit-inner-spin-button { opacity: 0.3; }
        .booking-dark label {
          color: var(--ll-text)A6 !important;
          font-size: 0.78rem !important;
          letter-spacing: 0.04em !important;
        }
        .booking-dark [role="checkbox"] {
          border: 1px solid color-mix(in srgb, var(--ll-text) 25%, transparent) !important;
          background: color-mix(in srgb, var(--ll-text) 5%, transparent) !important;
        ...
        .price-card {
          background: color-mix(in srgb, var(--ll-text) 4%, transparent) !important;
          border: 1px solid color-mix(in srgb, var(--ll-text) 8%, transparent) !important;
          border-radius: 10px !important;
        }
        .price-card .text-gray-500 { color: var(--ll-text)73 !important; }
        .price-card .text-gray-400 { color: var(--ll-text)59 !important; }
        .price-card .text-gray-800 { color: var(--ll-text) !important; }
        .price-card .text-sm { color: var(--ll-text)CC !important; }
        .price-card .font-semibold { color: var(--ll-text) !important; }
        .price-card [role="separator"],
        .price-card hr,
        .price-card .shrink-0 { background: color-mix(in srgb, var(--ll-text) 10%, transparent) !important; }
        ...
        .booking-dark .rdp-caption_label { color: var(--ll-text) !important; }
        .booking-dark .rdp-nav button { color: var(--ll-text)99 !important; }
        .booking-dark .rdp-nav button:hover { color: var(--ll-text) !important; background: color-mix(in srgb, var(--ll-text) 7%, transparent) !important; }
        .booking-dark .rdp-weekday { color: var(--ll-text)4D !important; font-size: 0.7rem !important; }
        .booking-dark .rdp-day_button { color: var(--ll-text) !important; border-radius: 6px !important; }
        .booking-dark .rdp-disabled .rdp-day_button,
        .booking-dark .rdp-day.rdp-disabled .rdp-day_button { color: var(--ll-text)33 !important; }
        ...
        .booking-dark .rdp-range_middle .rdp-day_button {
          background: color-mix(in srgb, var(--ll-accent) 15%, transparent) !important;
          color: var(--ll-text) !important;
        }
        ...
        .bk-submit-btn:hover:not(:disabled) { background: color-mix(in srgb, var(--ll-accent) 85%, black) !important; }
      ...
      <div className="bk-fade book-hdr" style={{ padding: "2.5rem 3rem 1.5rem" }}>
        ...
        >
          Request to{" "}
          <span style={{ color: "var(--ll-accent)" }}>Book</span>
        </h1>
        ...
        <div
          style={{
            ...
            border: "1px solid color-mix(in srgb, var(--ll-text) 9%, transparent)",
            borderRadius: "9999px",
