...
- **Global scope**: `/Users/LeonChen/Documents/direct booking site project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/LeonChen/Documents/direct booking site project/.claude/notes/`)
...
2. Glob `/Users/LeonChen/Documents/direct booking site project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/LeonChen/Documents/direct booking site project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/LeonChen/Documents/direct booking site project/.claude/notes/` — works in any directory
